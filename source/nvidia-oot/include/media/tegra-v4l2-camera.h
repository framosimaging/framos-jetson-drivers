...
#define TEGRA_CAMERA_CID_OPERATION_MODE             (TEGRA_CAMERA_CID_BASE+113)
#define TEGRA_CAMERA_CID_SYNC_MODE                  (TEGRA_CAMERA_CID_BASE+114)
#define TEGRA_CAMERA_CID_BROADCAST                  (TEGRA_CAMERA_CID_BASE+115)
#define TEGRA_CAMERA_CID_BLACK_LEVEL                (TEGRA_CAMERA_CID_BASE+116)
#define TEGRA_CAMERA_CID_HDR_CONTROL                (TEGRA_CAMERA_CID_BASE+117)
#define TEGRA_CAMERA_CID_HDR_LIN_KNEE1              (TEGRA_CAMERA_CID_BASE+118)
#define TEGRA_CAMERA_CID_HDR_LIN_KNEE2              (TEGRA_CAMERA_CID_BASE+119)
#define TEGRA_CAMERA_CID_DIGITAL_GAIN               (TEGRA_CAMERA_CID_BASE+120)
#define TEGRA_CAMERA_CID_FLIP_MIRROR                (TEGRA_CAMERA_CID_BASE+121)
#define TEGRA_CAMERA_CID_SHUTTER_MODE               (TEGRA_CAMERA_CID_BASE+122)
#define TEGRA_CAMERA_CID_XVS_XHS_STATE              (TEGRA_CAMERA_CID_BASE+123)
